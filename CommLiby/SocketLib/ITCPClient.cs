    ...
    public abstract class ITCPClient
    {
        ...
        protected void OnSocketAsyncCompleted(object sender, ISocketAsyncEventArgs e)
        {
            ...
            try
            {
                ...
                else if (e.SocketError == SocketError.ConnectionReset || e.SocketError == SocketError.TimedOut || e.SocketError == SocketError.ConnectionRefused)
                {
