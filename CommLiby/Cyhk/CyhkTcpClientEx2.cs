...
namespace CommLiby.Cyhk
{
    public static class CyhkTcpClientEx2
    {
        ...
        public static void SendGSYJMsg(this ICar car, string msg, string usreName, char type = 'S')
        {
            if (car == null) return;
            CyhkTcpClient.Instance.SendGSYJMsg(car, msg, usreName, type);
        }
        ...
        /// </summary>
        /// <param name="car"></param>
        public static void OpenDakunji(this ICar car)
        {
            if (car == null) return;
            CyhkTcpClient.Instance.OpenDakunji(car);
        }
        /// <summary>
        /// 关闭打捆机
        /// </summary>
        /// <param name="car"></param>
        public static void CloseDakunji(this ICar car)
        {
            if (car == null) return;
            CyhkTcpClient.Instance.CloseDakunji(car);
        }
        ...
        /// </summary>
        /// <param name="car"></param>
        public static void OpenDakunjiNew(this ICar car)
        {
            if (car == null) return;
            CyhkTcpClient.Instance.OpenDakunjiNew(car);
        }
        /// <summary>
        /// 关闭打捆机 新
        /// </summary>
        /// <param name="car"></param>
        public static void CloseDakunjiNew(this ICar car)
        {
            if (car == null) return;
            CyhkTcpClient.Instance.CloseDakunjiNew(car);
        }
        ...
        public static void DeviceSet(this ICar car, Dictionary<byte, object> paras)
        {
            if (car == null) return;
            CyhkTcpClient.Instance.DeviceSet(car, paras);
        }
