...
namespace CommLiby.Cyhk.Models
{
    public class AlarmStatus
    {
        ...
        public void RefreshAlarmStatus(uint alarmStatus)
        {
            ...
            speedingup_alarm = (alarmStatus & 0x200000) == 0x200000;
            emergencybrake_alarm = (alarmStatus & 0x400000) == 0x400000;
        ...
        /// 急加速报警
        /// </summary>
        public bool speedingup_alarm
        {
            get { return _speedingupAlarm; }
            set
            {
                _speedingupAlarm = value;
                if (value)
                {
                    AddStatusStr("急加速");
                }
