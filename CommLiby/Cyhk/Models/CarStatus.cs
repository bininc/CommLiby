...
namespace CommLiby.Cyhk.Models
{
    ...
    {
        private volatile List<string> _statusList = new List<string>();
        ...
        public void RefreshStatus(uint carStatus, ushort stopTime)
        {
            ...
            if (stopTime > 0)
            {
                AddStatusStr("停车:" + new TimeSpan(0, 0, stopTime, 0).ToFormatString());
            }
        }
        ...
        /// 隐藏安全带状态
        /// </summary>
        public static bool hide_safetybelt_state;
